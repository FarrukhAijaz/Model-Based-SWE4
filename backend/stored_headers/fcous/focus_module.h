/**
 * @file focus_module.h
 * @brief Defines the abstract base class module for all software components.
 * 
 * This class provides a common interface for all software modules in the focus framework,
